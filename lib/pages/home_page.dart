  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          // preferredsize is indicating the creator made by harshita
          bottom:  PreferredSize(
        child: Text(" Made by Harshita",),
        preferredSize: Size.zero),
          
        ),
        // return a costumm widget'dashchat'designed for building caht interface
        body: _buildUI());
  }
